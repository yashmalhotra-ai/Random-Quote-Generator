        ...
        <>
                ...
                <div className="flex flex-col items-center container m-auto min-h-screen">
                    {bookmarks.length !== 0 ? (
                        bookmarks.map((bookmark) => (
                            <div key={bookmark._id} className="flex flex-col mt-10">
                                <div className="flex flex-col w-[500px] min-h-5 mb-2  bg-boxbackground rounded-[60px]">
                                    <p className="w-[85%] m-auto pt-4 text-textColor leading-relaxed text-base">{bookmark.content}</p>
                                    <p className="w-[85%] m-auto pt-4 text-center text-textColor leading-relaxed text-base">-{bookmark.author}</p>
                                </div>
                                <div
                                    className=" relative left-[30%] top-[-30px] item-end m-auto leading-relaxed text-base hover:cursor-pointer"
			...
			c-7.219,0-13.07,5.854-13.07,13.07v147.154C298.213,417.012,304.067,422.863,311.284,422.863z"/>
                        ...
                        <div className="flex flex-col mt-10">
                            <div className="flex flex-col w-[500px] min-h-5 mb-2  bg-boxbackground rounded-[60px]">
                                <p className="w-[85%] m-auto pt-4 text-textColor leading-relaxed text-base">No Bookmarks Found</p>
                            </div>
                        </div>
                    )}
                </div>
